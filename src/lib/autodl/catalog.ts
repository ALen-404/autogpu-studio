...
const AUTODL_MODEL_BUNDLES: AutoDLModelBundle[] = [
  {
    ...
    displayName: '低级',
    tagline: '省钱，适合先跑通流程',
    description: '轻量视频、基础生图、文字分析和普通 TTS，适合测试分镜到成片链路。',
    recommendedProfileId: '5090-p',
    supportedProfileIds: ['5090-p', 'pro6000-p'],
    modelIds: ['ltx-video-2b-distilled', 'sdxl-sd35-medium', 'qwen3-8b-instruct', 'cosyvoice3-0.5b'],
    featureTags: ['省钱', '轻量视频', '基础生图', '文字分析', '普通 TTS'],
  },
  {
    id: 'balanced',
    displayName: '中级',
    tagline: '质量和速度比较均衡',
    description: '更好的视频和图片质量，保留文字分析与 TTS，适合日常创作。',
    recommendedProfileId: '5090-p',
    supportedProfileIds: ['5090-p', 'pro6000-p'],
    modelIds: ['wan2.2-ti2v-5b', 'flux2-klein-4b', 'qwen3-8b-instruct', 'f5-tts-v1'],
    featureTags: ['均衡', '视频生成', '高清生图', '文字分析', '自然 TTS'],
  },
  {
    id: 'advanced',
    displayName: '高级',
    tagline: '质量优先，适合正式出片',
    description: '高质量视频、图片编辑、大图生成、强文字模型和高级 TTS，建议用 PRO6000。',
    recommendedProfileId: 'pro6000-p',
    supportedProfileIds: ['pro6000-p'],
    modelIds: ['wan2.2-i2v-a14b', 'ltx-video-13b-fp8', 'qwen-image-edit', 'qwen3-32b-instruct', 'indextts2', 'fish-speech'],
    featureTags: ['高质量', '图生视频', '图片编辑', '强文字', '高级 TTS'],
  },
]
